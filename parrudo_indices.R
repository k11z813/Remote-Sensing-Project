...
cor.results.f <- c(report_table(c1.f),
                   ...
                   report_table(c3.f),
                   report_table(c4.f))
display(cor.results.f)
export_table(cor.results.f, format="html")
...
growth.stage <- c(rep("V6",40),rep("Three Nodes",40),rep("Flowering",40))
...
points(ndvi[growth.stage=="V6"], bio[growth.stage=="V6"], pch=16, col="darkcyan", cex=1)
points(ndvi[growth.stage=="Three Nodes"], bio[growth.stage=="Three Nodes"], pch=15, col="plum3",cex=1)
points(ndvi[growth.stage=="Flowering"], bio[growth.stage=="Flowering"], pch=17, col="khaki2" ,cex=1)
legend(0.57,10500,legend=c("V6", "Three Nodes", "Flowering"),
       pch=c(16,15,17), col=c("darkcyan","plum3","khaki2"), cex=c(0.7,0.7,0.7), bty="n")
...
points(osavi[growth.stage=="V6"], bio[growth.stage=="V6"], pch=16, col="darkcyan", cex=1)
points(osavi[growth.stage=="Three Nodes"], bio[growth.stage=="Three Nodes"], pch=15, col="plum3",cex=1)
points(osavi[growth.stage=="Flowering"], bio[growth.stage=="Flowering"], pch=17, col="khaki2" ,cex=1)
legend(0.37,10500,legend=c("V6", "Three Nodes", "Flowering"),
       pch=c(16,15,17), col=c("darkcyan","plum3","khaki2"), cex=c(0.7,0.7,0.7), bty="n")
...
points(ndre[growth.stage=="V6"], bio[growth.stage=="V6"], pch=16, col="darkcyan", cex=1)
points(ndre[growth.stage=="Three Nodes"], bio[growth.stage=="Three Nodes"], pch=15, col="plum3",cex=1)
points(ndre[growth.stage=="Flowering"], bio[growth.stage=="Flowering"], pch=17, col="khaki2" ,cex=1)
legend(0.09,10500,legend=c("V6", "Three Nodes", "Flowering"),
       pch=c(16,15,17), col=c("darkcyan","plum3","khaki2"), cex=c(0.7,0.7,0.7), bty="n")
...
points(reci[growth.stage=="V6"], bio[growth.stage=="V6"], pch=16, col="darkcyan", cex=1)
points(reci[growth.stage=="Three Nodes"], bio[growth.stage=="Three Nodes"], pch=15, col="plum3",cex=1)
points(reci[growth.stage=="Flowering"], bio[growth.stage=="Flowering"], pch=17, col="khaki2" ,cex=1)
legend(17,9500,legend=c("V6", "Three Nodes", "Flowering"),
       pch=c(16,15,17), col=c("darkcyan","plum3","khaki2"), cex=c(0.7,0.7,0.7), bty="n")
...
#################### 
#v6
ndvi.v <-  matrix(data = c(ndvi[growth.stage=="V6"], bio[growth.stage=="V6"]),ncol = 2)
...
##################### 
#v6
osavi.v <-  matrix(data = c(osavi[growth.stage=="V6"], bio[growth.stage=="V6"]),ncol = 2)
...
#################### 
#v6
ndre.v <-  matrix(data = c(ndre[growth.stage=="V6"], bio[growth.stage=="V6"]),ncol = 2)
...
#################### 
#v6
reci.v <-  matrix(data = c(reci[growth.stage=="V6"], bio[growth.stage=="V6"]),ncol = 2)
